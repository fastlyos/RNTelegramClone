      ...
      <ModalView
        ...
        <React.Fragment>
          <View style={sharedStyles.titleContainer}>
            ...
            <Text style={sharedStyles.textModal}>{"Test for modal blur effects"}</Text>
            <Text style={[sharedStyles.textModalSubtitle, { marginTop: 5 }]}>
              {"Available Styles: "}
              <Text style={{ fontWeight: "bold" }}>{`${availableBlurStylesCount}`}</Text>
            </Text>
            <Text style={[sharedStyles.textModalSubtitle, { marginTop: 5 }]}>
              {"Total Available Styles: "}
              <Text style={{ fontWeight: "bold" }}>{`${totalBlurStylesCount}`}</Text>
            </Text>
          </View>
          <View style={sharedStyles.textModalContainer}>
            <Text style={sharedStyles.textModalSubtitle}>
              {"UIBlurEffectStyle: "}
              <Text style={{ fontWeight: "bold" }}>{`${currentBlurEffectStyle}`}</Text>
            </Text>
          </View>
          <TouchableOpacity
            ...
            <Text style={sharedStyles.buttonText}>{"🌼 Next Blur Style"}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={sharedStyles.button}
            onPress={() => {
            ...
            <Text style={sharedStyles.buttonText}>{`${isModalBGTransparent ? "☀️" : "🌙"} Toggle isModalBGTransparent`}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={sharedStyles.button}
            onPress={() => {
            ...
            <Text style={sharedStyles.buttonText}>{`${isModalBGBlurred ? "☀️" : "🌙"} Toggle isModalBGBlurred`}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={sharedStyles.button}
            onPress={() => {
