      ...
      <ModalView
        ...
        <>
          <View style={sharedStyles.titleContainer}>
            ...
            <Text style={sharedStyles.textModal}>{"Test for modal transition styles"}</Text>
            <Text style={[sharedStyles.textModalSubtitle, { marginTop: 5 }]}>
              {"Available Styles: "}
              <Text style={{ fontWeight: "bold" }}>{`${totalPresentationStylesCount}`}</Text>
            </Text>
          </View>
          <View style={sharedStyles.textModalContainer}>
            <Text style={sharedStyles.textModalSubtitle}>
              {"UIModalPresentationStyle: "}
              <Text style={{ fontWeight: "bold" }}>{`${currentPresentationStyle}`}</Text>
            </Text>
          </View>
          <TouchableOpacity
            ...
            <Text style={sharedStyles.buttonText}>{"🌼 Next Presentation Style"}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={sharedStyles.button}
            onPress={() => {
