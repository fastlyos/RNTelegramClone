      ...
      <ModalView
        ...
        <React.Fragment>
          <View style={sharedStyles.titleContainer}>
            ...
            <Text style={sharedStyles.textModal}>{"Toggle isModalInPresentation"}</Text>
          </View>
          <View style={sharedStyles.textModalContainer}>
            <Text style={sharedStyles.textModalSubtitle}>
              {"isModalInPresentation: "}
              <Text style={{ fontWeight: "bold" }}>{state.isModalInPresentation ? "ON" : "OFF"}</Text>
            </Text>
            <Text style={[sharedStyles.textModalSubtitle, { marginTop: 10 }]}>
              {"enableSwipeGesture: "}
              <Text style={{ fontWeight: "bold" }}>{state.enableSwipeGesture ? "ON" : "OFF"}</Text>
            </Text>
            <Text style={[sharedStyles.textModalSubtitle, { marginTop: 10 }]}>
              {"Current Event: "}
              <Text style={{ fontWeight: "bold" }}>{state.event ?? "N/A"}</Text>
            </Text>
            <Text style={[sharedStyles.textModalSubtitle, { marginTop: 10 }]}>
              {"Event Count: "}
              <Text style={{ fontWeight: "bold" }}>{state.eventCount}</Text>
            </Text>
          </View>
          <TouchableOpacity
            ...
            <Text style={sharedStyles.buttonText}>{`${state.isModalInPresentation ? "☀️" : "🌙"} Toggle isModalInPresentation`}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={sharedStyles.button}
            onPress={() => {
            ...
            <Text style={sharedStyles.buttonText}>{`${state.enableSwipeGesture ? "☀️" : "🌙"} Toggle enableSwipeGesture`}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={sharedStyles.button}
            onPress={() => {
            ...
            <Text style={sharedStyles.buttonText}>{"🚫 Close Modal"}</Text>
          </TouchableOpacity>
        </React.Fragment>
      </ModalView>
    );
