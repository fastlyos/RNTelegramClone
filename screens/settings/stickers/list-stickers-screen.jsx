...
import { stickerList } from "./schema";
        ...
        <SectionList
          ...
          renderSectionFooter={({ section: { footerTitle } }) => (
            <View style={styles.footerView}>
              {!!footerTitle && typeof footerTitle === "string" && (
                <Text type="caption2" color={COLORS.title}>
                  {footerTitle}
                </Text>
              )}
              {!!footerTitle &&
                typeof footerTitle === "object" &&
                footerTitle.map((text) => (
                  <Text type="caption2" color={COLORS.title}>
                    {text}
                  </Text>
                ))}
...
ListStickersScreen.defaultProps = {};
export default ListStickersScreen;
